...
const LEVELS = {
  1: {
    image: "/assets/farm_twins_cropped.png", // client/public/assets/ 에 위치
    base: { w: 1024, h: 500 },
    // ↓ 일단 예시 10개. 에디터 모드로 20개 채워넣으면 됨.
    spots: [
      { id: 0, nx: 0.14, ny: 0.36, nr: 0.018 },
      { id: 1, nx: 0.242, ny: 0.405, nr: 0.018 },
      { id: 2, nx: 0.33, ny: 0.47, nr: 0.018 },
      { id: 3, nx: 0.42, ny: 0.41, nr: 0.018 },
      { id: 4, nx: 0.512, ny: 0.43, nr: 0.018 },
      { id: 5, nx: 0.605, ny: 0.455, nr: 0.018 },
      { id: 6, nx: 0.705, ny: 0.52, nr: 0.018 },
      { id: 7, nx: 0.805, ny: 0.46, nr: 0.018 },
      { id: 8, nx: 0.9, ny: 0.6, nr: 0.018 },
      { id: 9, nx: 0.96, ny: 0.38, nr: 0.018 },
    ],
  },
};
